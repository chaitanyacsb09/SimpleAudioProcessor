...
//==============================================================================
juce::ARAPlaybackRenderer* SimpleAudioProcessorDocumentController::doCreatePlaybackRenderer() noexcept
{
    return new SimpleAudioProcessorPlaybackRenderer (getDocumentController());
}

//==============================================================================
bool SimpleAudioProcessorDocumentController::doRestoreObjectsFromStream (juce::ARAInputStream& input, const juce::ARARestoreObjectsFilter* filter) noexcept
{
...
bool SimpleAudioProcessorDocumentController::doStoreObjectsToStream (juce::ARAOutputStream& output, const juce::ARAStoreObjectsFilter* filter) noexcept
{
...
{
    return juce::ARADocumentControllerSpecialisation::createARAFactory<SimpleAudioProcessorDocumentController>();
}
